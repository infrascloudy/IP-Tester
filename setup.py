...
#
# However, when we do this, we also import `IPTest/__init__.py'. If this
...
def _lint():
    ...
    retcode = subprocess.call(
        ['flake8', '--max-complexity=15'] + project_python_files)
    if retcode == 0:
...
setup_dict = dict(
    ...
    install_requires=['dnspython'] + python_version_specific_requires,
    ...
    entry_points={
        'console_scripts': [
            'iptest = IPTest.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'IPTest_gui = IPTest.gui:entry_point'
        # ]
    }
)
